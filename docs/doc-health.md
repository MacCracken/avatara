...
_Last swept: 2026-07-22 (v2.12.0 — world traditions part 2: named-nation re-attribution, the Seven Grandfather Teachings, separator normalisation)._

Ground truth at this sweep: **504 archetypes, 35 traditions**; version **2.12.0**;
cyrius pin **6.4.71**; 210 integration tests; 57 benchmarks; `ArchetypeProfile`
...
| `CHANGELOG.md` | 2026-07-22 | ✅ Fresh | Entries through 2.12.0 (world traditions part 2); `[Unreleased]` points at the roadmap (minors → 3.0.0). |
| `CLAUDE.md` | 2026-07-22 | ✅ Fresh | Version 2.12.0, compiler 6.4.71; main.cyr=smoke / tcyr=210 / bcyr=57; all tradition modules incl. tarot/iching/inuit/lakota/haudenosaunee/anishinaabe/aboriginal + struct/Result/domain/shadow/xalloc API. |
...
| Doc | Last touched | Status | Notes |
|-----|--------------|--------|-------|
| `docs/development/roadmap.md` | 2026-07-22 | ✅ Fresh | Shipped through 2.12.0 (world traditions part 2); remaining minor v2.13.0 (overlays) → v3.0.0 consolidation; Backlog: the 2.11.x Aboriginal Australian arc (community-reviewed sourcing, then fuller coverage gated on it) and the additive Tarot de Marseille attribution; affinity-graph declined. |
