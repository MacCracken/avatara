...
_Last swept: 2026-07-22 (v2.12.1 — Aboriginal sourcing corrections from the v2.14.0 desk research; Baiame excluded, not deferred)._

Ground truth at this sweep: **504 archetypes, 35 traditions**; version **2.12.1**;
...
| `CHANGELOG.md` | 2026-07-22 | ✅ Fresh | Entries through 2.12.1 (Aboriginal sourcing corrections); `[Unreleased]` points at the roadmap (minors → 3.0.0). |
| `CLAUDE.md` | 2026-07-22 | ✅ Fresh | Version 2.12.1, compiler 6.4.71; main.cyr=smoke / tcyr=210 / bcyr=57; all tradition modules incl. tarot/iching/inuit/lakota/haudenosaunee/anishinaabe/aboriginal + struct/Result/domain/shadow/xalloc API. |
...
| Doc | Last touched | Status | Notes |
|-----|--------------|--------|-------|
| `docs/development/roadmap.md` | 2026-07-22 | ✅ Fresh | Shipped through 2.12.0 (world traditions part 2); remaining minors v2.13.0 (overlays) and v2.14.0 (Aboriginal Australian depth, with the community-review gate recorded BLOCKED — no community engaged) → v3.0.0 consolidation; Backlog: additive Tarot de Marseille attribution; affinity-graph declined. |
