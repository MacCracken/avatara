...
_Last swept: 2026-07-22 (v2.13.0 — archetype overlays: Enneagram + Jungian, derived over the profile)._

Ground truth at this sweep: **504 archetypes, 35 traditions**; version **2.13.0**;
cyrius pin **6.4.71**; 241 integration tests; 60 benchmarks; `ArchetypeProfile`
...
| `CHANGELOG.md` | 2026-07-22 | ✅ Fresh | Entries through 2.13.0 (archetype overlays); `[Unreleased]` points at the roadmap (minors → 3.0.0). |
| `CLAUDE.md` | 2026-07-22 | ✅ Fresh | Version 2.13.0, compiler 6.4.71; main.cyr=smoke / tcyr=241 / bcyr=60; all tradition modules incl. tarot/iching/inuit/lakota/haudenosaunee/anishinaabe/aboriginal + struct/Result/domain/shadow/xalloc API. |
...
| Doc | Last touched | Status | Notes |
|-----|--------------|--------|-------|
| `docs/development/roadmap.md` | 2026-07-22 | ✅ Fresh | Shipped through 2.13.0 (archetype overlays); remaining minor v2.14.0 (Aboriginal Australian depth, with the community-review gate recorded BLOCKED — no community engaged) → v3.0.0 consolidation; Backlog: additive Tarot de Marseille attribution; affinity-graph declined. |
