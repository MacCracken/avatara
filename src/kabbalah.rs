...
impl Archetype for Sephira {
    ...
    fn profile(&self) -> ArchetypeProfile {
        let (traits, emphasis, breath, growth, desc, soul, spirit) = match self {
            Self::Kether => (
                TraitWeights { patience: 1.0, empathy: 1.0, confidence: 1.0, curiosity: 0.0, creativity: 0.0, directness: 0.0, humor: 0.0, formality: 0.0, verbosity: 0.0, warmth: 1.0, courage: 1.0, precision: 0.0, skepticism: 0.0, autonomy: 1.0, pedagogy: 0.0 },
                ModuleEmphasis { belief: 1.0, intuition: 1.0, eq: 1.0, ..Default::default() },
            ...
            Self::Chokmah => (
                TraitWeights { curiosity: 0.9, creativity: 0.9, confidence: 0.8, directness: 0.7, courage: 0.9, autonomy: 0.9, patience: 0.3, precision: 0.3, ..Default::default() },
                ModuleEmphasis { intuition: 0.9, growth: 0.8, spirit: 0.9, energy: 0.8, ..Default::default() },
            ...
            Self::Binah => (
                TraitWeights { patience: 0.9, precision: 0.9, empathy: 0.8, formality: 0.7, pedagogy: 0.8, warmth: 0.7, skepticism: 0.6, ..Default::default() },
                ModuleEmphasis { reasoning: 0.9, belief: 0.8, regulation: 0.8, relationship: 0.7, ..Default::default() },
                BreathAffinity::EarlyExhale,
            ...
            Self::Chesed => (
                TraitWeights { warmth: 0.9, empathy: 0.9, patience: 0.8, confidence: 0.7, pedagogy: 0.7, humor: 0.6, creativity: 0.7, ..Default::default() },
                ModuleEmphasis { growth: 0.9, relationship: 0.8, spirit: 0.8, mood: 0.7, ..Default::default() },
            ...
            Self::Gevurah => (
                TraitWeights { directness: 0.9, confidence: 0.9, courage: 0.9, skepticism: 0.8, precision: 0.8, patience: 0.3, warmth: 0.3, humor: 0.2, ..Default::default() },
                ModuleEmphasis { stress: 0.8, regulation: 0.9, appraisal: 0.8, energy: 0.7, ..Default::default() },
                BreathAffinity::MidExhale,
            ...
            Self::Tiphareth => (
                TraitWeights { warmth: 0.8, confidence: 0.8, empathy: 0.7, creativity: 0.7, patience: 0.7, courage: 0.7, directness: 0.6, pedagogy: 0.6, ..Default::default() },
                ModuleEmphasis { mood: 0.8, spirit: 0.8, eq: 0.8, belief: 0.7, growth: 0.7, ..Default::default() },
            ...
            Self::Netzach => (
                TraitWeights { creativity: 0.9, warmth: 0.8, empathy: 0.7, humor: 0.7, courage: 0.6, curiosity: 0.7, ..Default::default() },
                ModuleEmphasis { spirit: 0.9, mood: 0.8, relationship: 0.8, energy: 0.7, ..Default::default() },
                BreathAffinity::LateExhale,
                GrowthDirection::Differentiate,
            ...
            Self::Hod => (
                TraitWeights { precision: 0.9, pedagogy: 0.8, formality: 0.7, directness: 0.7, skepticism: 0.7, verbosity: 0.6, ..Default::default() },
                ModuleEmphasis { reasoning: 0.9, salience: 0.7, flow: 0.7, ..Default::default() },
                BreathAffinity::LateExhale,
                GrowthDirection::Differentiate,
            ...
            Self::Yesod => (
                TraitWeights { empathy: 0.8, creativity: 0.7, curiosity: 0.7, patience: 0.6, warmth: 0.6, ..Default::default() },
                ModuleEmphasis { intuition: 0.9, mood: 0.8, relationship: 0.7, belief: 0.7, ..Default::default() },
                BreathAffinity::LateExhale,
                GrowthDirection::Integrate,
            ...
            Self::Malkuth => (
                TraitWeights { patience: 0.7, precision: 0.7, warmth: 0.6, confidence: 0.6, courage: 0.6, directness: 0.6, ..Default::default() },
                ModuleEmphasis { energy: 0.9, stress: 0.7, salience: 0.8, mood: 0.7, ..Default::default() },
                BreathAffinity::LateExhale,
                GrowthDirection::Preserve,
