...
**374 archetypes across 27 traditions** (incl. the solar-year intercalary set; +Canaanite & Etruscan). Written in Cyrius, compiled by the Cyrius compiler 6.1.34+.
...
Requires the Cyrius compiler 6.1.34+ (pinned in `cyrius.cyml`).
