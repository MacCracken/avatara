...
fn main() {
    ...
    println!("  warmth={:.2}    confidence={:.2}", profile.traits.warmth, profile.traits.confidence);
    println!("  empathy={:.2}   patience={:.2}", profile.traits.empathy, profile.traits.patience);
    println!("  precision={:.2} courage={:.2}", profile.traits.precision, profile.traits.courage);
    println!();
    println!("Breath: {:?} (intensity {:.2})", profile.breath, profile.breath.intensity());
